...
class Cook < Merchant
  ...
  def setupMerchant(me)
    ...
    $api.createItemInBackpack(me, 0x012C) # ham
    $api.createItemInBackpack(me, 0x0136) # bread
    $api.createItemInBackpack(me, 0x0137) # pie
    $api.createItemInBackpack(me, 0x02FF) # grapes
  end
end
