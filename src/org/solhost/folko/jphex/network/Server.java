 ...
 ******************************************************************************/
package org.solhost.folko.jphex.network;
...
import org.solhost.folko.jphex.ErrorHandler;
    ...
    public void eventLoop(ErrorHandler errorHandler) {
        while(!Thread.interrupted()) {
            ...
            for(SelectionKey key : selector.selectedKeys()) {
                // key become invalid at any time, so always check directly before checking something else
